...
public class TrainModel {
    ...
    public void instantiateUI(){
        ...
        blockPower = new Label("Block Power : ");
        ...
        //Row Index 3
        doorLabel = new Label("Door Status : ");
        ...
        passengersLabel = new Label("Numb. of Passengers : ");
