...
public class MBO {
	...
	public void setClearLocalInfo(int trainID, String line, Integer blockNumber) {
		 // infer CTCMain to update Train Location
        CTCMain.updateTrainLocal(trainID, line, blockNumber);
	};
}
